...
input_path = "/panel_master/courses_initial.csv"
processed_csv_path = "/panel_master/courses_processed.csv"

def process_csv(input_file_path, processed_csv_path, column_name = "Mp3", split_by = "/", replace_char = "_", new_column_name = "Course_Name"):
    '''
